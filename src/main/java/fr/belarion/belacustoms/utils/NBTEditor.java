...
/**
* @return la representation texte complete du NBT "tag" de l'item (format
* SNBT natif de Minecraft, ex: {CustomItemId:"EMERALD_HAMMER",Unbreakable:1b}),
* ou null si l'item n'a aucun tag NBT. Lecture seule : ne modifie jamais
* l'item. Reserve au debug (voir commands.DebugCommand / /beladebug).
*/
public static String getRawTagString(ItemStack item) {
if (!available || item == null) return null;
try {
Object nmsItem = toNMSCopy(item);
Class<?> nmsItemStackClass = nmsClass("ItemStack");
